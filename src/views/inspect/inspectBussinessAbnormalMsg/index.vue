  ...
  <div class="dashboard-container">
    <div class="dashboard-form">
      ...
      >
        ...
        <el-table-column prop="badMsg" label="列入异常名录原因" />
        <el-table-column prop="filed1" label="列入日期" />
        <el-table-column prop="filed2" label="作出决定机关" />
        <el-table-column prop="filed4" label="移出经营异常名录原因" />
        <el-table-column prop="filed5" label="移出日期" />
        <el-table-column prop="filed6" label="作出移出决定机关" />
